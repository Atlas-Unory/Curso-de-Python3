...
os não nomeados devem ser enviados na ordem dos paametros passados na declaração da função, neste caso soma()
...
mesmo que a ordem seja dos argumentos seja diferente do que está nos paramentos não via mudar o resultado final pois eles estão nomeados
